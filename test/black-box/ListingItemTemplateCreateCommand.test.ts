...
import { ListingItemTemplateCreateCommand } from '../../src/api/commands/listingitemtemplate/ListingItemTemplateCreateCommand';

describe('ListingItemTemplateCreateCommand', () => {

    const testUtil = new BlackBoxTestUtil();
    const favoriteItemService = null;
    const method =  new ListingItemTemplateCreateCommand(favoriteItemService, Logger).name;
