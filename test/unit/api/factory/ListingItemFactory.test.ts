...
describe('ListingItemFactory', () => {
    ...
    const expectMessageFromListingItem = (message: ListingItemMessage, testData: resources.ListingItemTemplate) => {
        ...
        expect(message.objects[0].table[0].key).toBe(testData.ListingItemObjects[0].ListingItemObjectData[0].key);
        expect(message.objects[0].table[0].value).toBe(testData.ListingItemObjects[0].ListingItemObjectData[0].value);
        ...
        expect(message.objects[0].table[1].key).toBe(testData.ListingItemObjects[0].ListingItemObjectData[1].key);
        expect(message.objects[0].table[1].value).toBe(testData.ListingItemObjects[0].ListingItemObjectData[1].value);
        ...
        expect(message.objects[1].options[0].name).toBe(testData.ListingItemObjects[1].ListingItemObjectData[0].key);
        expect(message.objects[1].options[0].value).toBe(testData.ListingItemObjects[1].ListingItemObjectData[0].value);
        ...
        expect(message.objects[1].options[1].name).toBe(testData.ListingItemObjects[1].ListingItemObjectData[1].key);
        expect(message.objects[1].options[1].value).toBe(testData.ListingItemObjects[1].ListingItemObjectData[1].value);
    };
