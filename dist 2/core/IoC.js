...
class IoC {
    ...
    bindMessageProcessors() {
        return this.bindFiles('/messageprocessors/**/*Processor.ts', constants_1.Targets.MessageProcessor, (name, value) => this.bindFile(constants_1.Types.MessageProcessor, name, value));
    }
    bindMiddlewares() {
