...
const MessageException_1 = require("../../api/exceptions/MessageException");
class ImageProcessing {
     ...
     */
    static convertToJPEG(imageRaw) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const buf = Buffer.from(imageRaw, 'base64');
            const image = yield Jimp.read(buf);
            const retval = image.getBuffer(Jimp.MIME_JPEG, (err, buffer) => {
     ...
     */
    static resizeImageData(imageRaw, toVersions) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const imageDatas = new Map();
            for (const version of toVersions) {
                const resizedImageData = yield ImageProcessing.resizeImageToVersion(imageRaw, version);
     ...
     * @returns {Promise<string>}
     */
    static resizeImageToVersion(imageRaw, version) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (version.imageWidth > 0 && version.imageHeight > 0) {
                ...
                const resizedImage = yield imageBuffer.getBuffer(Jimp.MIME_JPEG, (err, buffer) => {
                    return buffer.toString('base64');
                });
                return resizedImage;
            }
    ...
    static resizeImageToFraction(imageRaw, fraction) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const dataBuffer = Buffer.from(imageRaw, 'base64');
            const imageBuffer = yield Jimp.read(dataBuffer);
            // resize only if target sizes > 0, else return original
    ...
    static compressImage(imageRaw, byteLimit) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            let quality = 100;
            // let imageData;
            let numIterations = 0;
            do {
                ...
                if (numIterations > this.MAX_COMPRESSION_ITERATIONS) {
                    ...
                    throw new MessageException_1.MessageException(`Couldn't compress image enough within ${this.MAX_COMPRESSION_ITERATIONS}`
                        + ` iterations! Size is ${imageRaw.length}!`);
                }
                const imageRaw2 = yield this.downgradeQuality(imageRaw, quality);
    ...
    static downgradeQuality(imageRaw, quality) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const dataBuffer = Buffer.from(imageRaw, 'base64');
            let imageBuffer = yield Jimp.read(dataBuffer);
            imageBuffer = imageBuffer.quality(quality);
            imageRaw = yield imageBuffer.getBuffer(Jimp.MIME_JPEG, (err, buffer) => {
                return buffer.toString('base64');
            });
...
ImageProcessing.milkcat = '/9j/4AAQSkZJRgABAQEAoACgAAD/4ReaRXhpZgAASUkqAAgAAAAMAA4BAgAgAAAAngAAAA8BAgAYAAAAvgAAABABAgAQAAAA1gAA'
...
ImageProcessing.milkcatBroken = '/9j/4AAQSkZJRgABAQEAoACgAAD/4RDpRXhpZgAAASDASSASAAAAAAAAAAAA';
// A shrunken picture of a Japanese cat with a milk carton on his head, converted to base64 using the *NIX command `base64`
ImageProcessing.milkcatSmall = '/9j/4AAQSkZJRgABAQEAoACgAAD/4RDpRXhpZgAASUkqAAgAAAAMAA4BAgAgAAAAngAAAA8BAgAYAAAAvgAAABABAgAQAAAA1gAA'
    + 'ABIBAwABAAAAAQAAABoBBQABAAAA5gAAABsBBQABAAAA7gAAACgBAwABAAAAAgAAADEBAgAMAAAA9gAAADIBAgAUAAAAAgEAABMC'
    + 'AwABAAAAAgAAAGmHBAABAAAAOAMAAKXEBwAiAgAAFgEAAMINAABPTFlNUFVTIERJR0lUQUwgQ0FNRVJBICAgICAgICAgAE9MWU1Q'
...
ImageProcessing.milkcatTall = '/9j/4AAQSkZJRgABAQEAoACgAAD/4RUdRXhpZgAASUkqAAgAAAAMAA4BAgAgAAAAngAAAA8BAgAYAAAAvgAAABABAgAQAAAA1gAA'
    + 'ABIBAwABAAAAAQAAABoBBQABAAAA5gAAABsBBQABAAAA7gAAACgBAwABAAAAAgAAADEBAgAMAAAA9gAAADIBAgAUAAAAAgEAABMC'
    + 'AwABAAAAAgAAAGmHBAABAAAAOAMAAKXEBwAiAgAAFgEAAMINAABPTFlNUFVTIERJR0lUQUwgQ0FNRVJBICAgICAgICAgAE9MWU1Q'
...
ImageProcessing.milkcatWide = '/9j/4AAQSkZJRgABAQEAoACgAAD/4RI9RXhpZgAASUkqAAgAAAAMAA4BAgAgAAAAngAAAA8BAgAYAAAAvgAAABABAgAQAAAA1gAA'
    + 'ABIBAwABAAAAAQAAABoBBQABAAAA5gAAABsBBQABAAAA7gAAACgBAwABAAAAAgAAADEBAgAMAAAA9gAAADIBAgAUAAAAAgEAABMC'
    + 'AwABAAAAAgAAAGmHBAABAAAAOAMAAKXEBwAiAgAAFgEAAMINAABPTFlNUFVTIERJR0lUQUwgQ0FNRVJBICAgICAgICAgAE9MWU1Q'
    + 'VVMgSU1BR0lORyBDT1JQLiAgAEZFMzEwLFg4NDAsQzUzMACgAAAAAQAAAKAAAAABAAAAR0lNUCAyLjguMTYAMjAxODowMToxNiAy'
    ...
    + 'MjMC7lFpxUFn/9k=';
ImageProcessing.PIEXIF_JPEG_START_STR = 'data:image/jpeg;base64,';
ImageProcessing.MAX_COMPRESSION_ITERATIONS = 20;
