...
const postal_codes_js_1 = require("postal-codes-js");
class ShippingZips {
    static isCountryCodeSupported(countryCode) {
        if (!countryCode) {
            return false;
        }
        ...
        try {
            const retval = postal_codes_js_1.default.validate(countryCode, '___SOMETHINGTHATISNTAPOSTCODE___');
    ...
    /*
     */
    static validate(countryCode, zip) {
        return true;
        //
        // countryCode = countryCode.toString().toUpperCase();
...
exports.ShippingZips = ShippingZips;
//# sourceMappingURL=ShippingZips.js.map