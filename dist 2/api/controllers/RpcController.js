    ...
    handleRPC(res, body) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (commandType) {
                ...
                const rpcCommand = this.rpcCommandFactory.get(commandType);
                const newRpcRequest = yield rpcCommand.validate(rpcRequest);
                rpcRequest = newRpcRequest ? newRpcRequest : rpcRequest;
                const result = yield rpcCommand.execute(rpcRequest, this.rpcCommandFactory);
