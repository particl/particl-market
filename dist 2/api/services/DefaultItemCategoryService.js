...
let DefaultItemCategoryService = class DefaultItemCategoryService {
    ...
    seedDefaultCategories() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            let LEVEL1CHILD = yield this.insertOrUpdateCategory({ key: 'cat_particl', name: 'Particl', description: '', parent_item_category_id: ROOT.Id });
            yield this.insertOrUpdateCategory({ key: 'cat_particl_free_swag', name: 'Free Swag', description: '', parent_item_category_id: LEVEL1CHILD.Id });
            LEVEL1CHILD = yield this.insertOrUpdateCategory({ key: 'cat_high_value', name: 'High Value (10,000$+)', description: '', parent_item_category_id: ROOT.Id });
