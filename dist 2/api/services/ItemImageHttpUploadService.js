...
let ItemImageHttpUploadService = class ItemImageHttpUploadService {
    ...
    httpPostImageUpload(uploadRequest) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const listingItemTemplate = yield this.listingItemTemplateService.findOne(uploadRequest.listingItemTemplateId);
            for (const file of uploadRequest.request.files) {
                const createdItemImage = yield this.itemImageService.createFromFile(file, listingItemTemplate);
