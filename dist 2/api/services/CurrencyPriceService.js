...
let CurrencyPriceService = class CurrencyPriceService {
    ...
    search(options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.currencyPriceRepo.search(options);
        });
    }
    /**
     *
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            for (let toCurrency of toCurrencies) {
                ...
                if (SupportedCurrencies_1.SupportedCurrencies[toCurrency]) {
                    ...
                    throw new MessageException_1.MessageException(`Invalid or unsupported currency: ${toCurrency}.`);
                }
            }
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                return new Promise((resolve, reject) => {
                    this.apiRequest.get(process.env.CHASING_COINS_API + '/' + fromCurrency + '/' + toCurrency, {
                        strictSSL: false
                    ...
                    throw new MessageException_1.MessageException(`Invalid or unsupported currency, <${toCurrency}> or <${fromCurrency}>.`);
                });
            }
            catch (err) {
    ...
    needToUpdate(currencyUpdatedAt) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const ticker = new Date(currencyUpdatedAt).getTime();
