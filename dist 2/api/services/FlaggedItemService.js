...
let FlaggedItemService = class FlaggedItemService {
    constructor(listingItemService, flaggedItemRepo, Logger) {
...
FlaggedItemService = tslib_1.__decorate([
    ...
    tslib_1.__param(1, inversify_1.inject(constants_1.Types.Repository)), tslib_1.__param(1, inversify_1.named(constants_1.Targets.Repository.FlaggedItemRepository)),
    ...
    tslib_1.__metadata("design:paramtypes", [ListingItemService_1.ListingItemService,
        FlaggedItemRepository_1.FlaggedItemRepository, Object])
], FlaggedItemService);
