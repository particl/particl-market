...
let ShoppingCartItemService = class ShoppingCartItemService {
    ...
    findOneByCartIdAndListingItemId(cartId, listingItemId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.shoppingCartItemRepo.findOneByCartIdAndListingItemId(cartId, listingItemId);
        });
    }
    findAllByCartId(cartId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.shoppingCartItemRepo.findAllByCartId(cartId);
        });
    }
    create(body) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            // check that listingItems already added or not
            const isItemExistOnCart = yield this.findOneByCartIdAndListingItemId(body.shopping_cart_id, body.listing_item_id);
            if (isItemExistOnCart !== null) {
                this.log.warn(`ListingItem already exist in ShoppingCart`);
                throw new MessageException_1.MessageException(`ListingItem already exist in ShoppingCart`);
            }
