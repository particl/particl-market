...
let ItemInformationService = class ItemInformationService {
    ...
    create(data) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield this.findOne(itemInformation.Id);
    ...
    getOrCreateItemCategory(itemCategory) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            let result;
            if (itemCategory.key) {
                result = yield this.itemCategoryService.findOneByKey(itemCategory.key);
            }
            else if (itemCategory.id) {
                result = yield this.itemCategoryService.findOne(itemCategory.id);
            }
            else {
                result = yield this.itemCategoryService.create(itemCategory);
            }
            return result;
        });
    }
