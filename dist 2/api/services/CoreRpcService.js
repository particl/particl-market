...
let CoreRpcService = class CoreRpcService {
    ...
    lockUnspent(unlock, outputs) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const params = [unlock, outputs, true];
            return yield this.call('lockunspent', params);
        });
    }
    /**
