...
let OrderService = class OrderService {
    constructor(addressService, listingItemService, orderItemService, profileService, orderRepo, Logger) {
    ...
    create(data) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            for (const orderItemCreateRequest of orderItemCreateRequests) {
                ...
                const orderItemModel = yield this.orderItemService.create(orderItemCreateRequest);
...
OrderService = tslib_1.__decorate([
    ...
    tslib_1.__param(4, inversify_1.inject(constants_1.Types.Repository)), tslib_1.__param(4, inversify_1.named(constants_1.Targets.Repository.OrderRepository)),
