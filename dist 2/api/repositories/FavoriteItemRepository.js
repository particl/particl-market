...
let FavoriteItemRepository = class FavoriteItemRepository {
    ...
    findOne(id, withRelated = true) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.FavoriteItemModel.fetchById(id, withRelated);
        });
    }
    /**
    ...
    findOneByProfileIdAndListingItemId(profileId, itemId, withRelated = true) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.FavoriteItemModel.fetchByProfileIdAndListingItemId(profileId, itemId, withRelated);
        });
    }
    findAllByProfileId(profileId, withRelated) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.FavoriteItemModel.fetchFavoritesByProfileId(profileId, withRelated);
        });
    }
    create(data) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                return yield this.FavoriteItemModel.fetchById(favoriteItemCreated.id);
            }
            catch (error) {
