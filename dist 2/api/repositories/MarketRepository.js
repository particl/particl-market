...
let MarketRepository = class MarketRepository {
    ...
    getDefault(withRelated = true) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.findOneByName(process.env.DEFAULT_MARKETPLACE_NAME, withRelated);
        });
    }
    findAll() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
    ...
    findOne(id, withRelated = true) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.MarketModel.fetchById(id, withRelated);
        });
    }
    findOneByAddress(address, withRelated = true) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.MarketModel.fetchByAddress(address, withRelated);
        });
    }
    findOneByName(name, withRelated = true) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.MarketModel.fetchByName(name, withRelated);
        });
    }
    create(data) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                return yield this.MarketModel.fetchById(marketCreated.id);
            }
            catch (error) {
    ...
    update(id, data) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                return yield this.MarketModel.fetchById(marketUpdated.id);
            }
            catch (error) {
