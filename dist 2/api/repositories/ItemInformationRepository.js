...
let ItemInformationRepository = class ItemInformationRepository {
    ...
    findOne(id, withRelated = true) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.ItemInformationModel.fetchById(id, withRelated);
        });
    }
    findByItemTemplateId(listingItemTemplateId, withRelated = true) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.ItemInformationModel.findByItemTemplateId(listingItemTemplateId, withRelated);
        });
    }
    create(data) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const result = yield this.ItemInformationModel.fetchById(itemInformationCreated.id);
                return result;
            }
            catch (error) {
    ...
    update(id, data) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                return yield this.ItemInformationModel.fetchById(itemInformationUpdated.id);
            }
            catch (error) {
