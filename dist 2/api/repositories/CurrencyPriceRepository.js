    ...
    create(data) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                throw new DatabaseException_1.DatabaseException('Could not create the currencyPrice!' + error, error);
            }
        });
    }
    update(id, data) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                throw new DatabaseException_1.DatabaseException('Could not update the currencyPrice! ' + error, error);
            }
        });
    }
    destroy(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                throw new DatabaseException_1.DatabaseException('Could not delete the currencyPrice!' + error, error);
            }
        });
    }
};
