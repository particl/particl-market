    ...
    execute(data, rpcCommandFactory) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (data.params.length < 2) {
                throw new MessageException_1.MessageException(`Requires at least two parameters, but only ${data.params.length} were found.`);
            }
            ...
            if (fromCurrency !== 'PART') {
                throw new MessageException_1.MessageException(`fromCurrency must be PART, but was ${fromCurrency}.`);
            }
            else {
