...
class CommandEnumType extends ts_enums_1.Enum {
    constructor() {
        ...
        this.ITEMINFORMATION_ROOT = new Command_1.Command('iteminformation', 'information', true, [this.ITEMINFORMATION_GET, this.ITEMINFORMATION_UPDATE], Environment_1.EnvironmentType.ALL);
        ...
        this.PROPOSAL_GET = new Command_1.Command('proposalget', 'get', false);
        this.PROPOSAL_POST = new Command_1.Command('proposalpost', 'post', false);
        this.PROPOSAL_LIST = new Command_1.Command('proposallist', 'list', false);
        this.PROPOSAL_RESULT = new Command_1.Command('proposalresult', 'result', false);
        this.PROPOSAL_ROOT = new Command_1.Command('proposal', 'proposal', true, [this.PROPOSAL_GET, this.PROPOSAL_POST, this.PROPOSAL_LIST, this.PROPOSAL_RESULT], Environment_1.EnvironmentType.ALL);
        ...
        this.ORDERITEM_STATUS = new Command_1.Command('orderitemstatus', 'status', false);
        this.ORDERITEM_ROOT = new Command_1.Command('orderitem', 'orderitem', true, [this.ORDERITEM_STATUS], Environment_1.EnvironmentType.ALL);
        ...
        this.VOTE_POST = new Command_1.Command('votepost', 'post', false);
        this.VOTE_GET = new Command_1.Command('voteget', 'get', false);
        this.VOTE_LIST = new Command_1.Command('votelist', 'list', false);
        this.VOTE_ROOT = new Command_1.Command('vote', 'vote', true, [this.VOTE_POST, this.VOTE_GET, this.VOTE_LIST], Environment_1.EnvironmentType.ALL);
        this.SETTING_REMOVE = new Command_1.Command('settingremove', 'remove', false);
        this.SETTING_GET = new Command_1.Command('settingget', 'get', false);
        this.SETTING_LIST = new Command_1.Command('settinglist', 'list', false);
        this.SETTING_SET = new Command_1.Command('settingset', 'set', false);
        this.SETTING_ROOT = new Command_1.Command('setting', 'setting', true, [this.SETTING_REMOVE, this.SETTING_GET, this.SETTING_LIST, this.SETTING_SET], Environment_1.EnvironmentType.ALL);
        this.SMSG_SEARCH = new Command_1.Command('smsgsearch', 'search', false);
        this.SMSG_ROOT = new Command_1.Command('smsg', 'smsg', true, [this.SMSG_SEARCH], Environment_1.EnvironmentType.ALL);
