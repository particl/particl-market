    ...
    execute(data) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (itemInformation.listingItemId) {
                throw new MessageException_1.MessageException('ItemLocation cannot be removed because the ListingItem has allready been posted!');
            }
            else {
    ...
    getItemInformation(data) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (_.size(itemInformation) === 0 || _.size(itemInformation.ItemLocation) === 0) {
                ...
                throw new MessageException_1.MessageException(`ItemInformation or ItemLocation with the listingItemTemplateId=${data.params[0]} was not found!`);
            }
