...
let ShoppingCartItemRemoveCommand = class ShoppingCartItemRemoveCommand extends BaseCommand_1.BaseCommand {
    constructor(shoppingCartItemService, listingItemService, Logger) {
        super(CommandEnumType_1.Commands.SHOPPINGCARTITEM_REMOVE);
    ...
    execute(data) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (data.params[0] && data.params[1]) {
                ...
                const isItemExistOnCart = yield this.shoppingCartItemService.findOneByCartIdAndListingItemId(data.params[0], listingItemId);
                if (isItemExistOnCart === null) {
                    this.log.warn(`listing item not exist on shopping cart`);
                    throw new MessageException_1.MessageException(`listing item not exist on shopping cart`);
                }
                else {
                    // delete
...
], ShoppingCartItemRemoveCommand.prototype, "execute", null);
ShoppingCartItemRemoveCommand = tslib_1.__decorate([
...
exports.ShoppingCartItemRemoveCommand = ShoppingCartItemRemoveCommand;
//# sourceMappingURL=ShoppingCartItemRemoveCommand.js.map