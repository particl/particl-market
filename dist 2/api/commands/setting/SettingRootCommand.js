...
let SettingRootCommand = class SettingRootCommand extends BaseCommand_1.BaseCommand {
    constructor(Logger) {
        super(CommandEnumType_1.Commands.SETTING_ROOT);
        this.Logger = Logger;
...
], SettingRootCommand.prototype, "execute", null);
SettingRootCommand = tslib_1.__decorate([
    tslib_1.__param(0, inversify_1.inject(constants_1.Types.Core)), tslib_1.__param(0, inversify_1.named(constants_1.Core.Logger)),
    tslib_1.__metadata("design:paramtypes", [Object])
], SettingRootCommand);
exports.SettingRootCommand = SettingRootCommand;
//# sourceMappingURL=SettingRootCommand.js.map