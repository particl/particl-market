...
let SettingRemoveCommand = class SettingRemoveCommand extends BaseCommand_1.BaseCommand {
    constructor(Logger, settingService, profileService) {
        super(CommandEnumType_1.Commands.SETTING_REMOVE);
        this.Logger = Logger;
    ...
    execute(data, rpcCommandFactory) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.settingService.destroyByKeyAndProfileId(key, profileId);
        });
    }
    validate(data) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
...
], SettingRemoveCommand.prototype, "execute", null);
SettingRemoveCommand = tslib_1.__decorate([
...
//# sourceMappingURL=SettingRemoveCommand.js.map