...
let ProfileAddCommand = class ProfileAddCommand extends BaseCommand_1.BaseCommand {
    ...
    execute(data) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.profileService.create({
                name: data.params[0],
    ...
    validate(data) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (data.params.length < 1) {
                throw new MessageException_1.MessageException('Missing name.');
            }
            // check if profile already exist for the given name
            const exists = yield this.profileService.findOneByName(data.params[0])
