...
let ShoppingCartGetCommand = class ShoppingCartGetCommand extends BaseCommand_1.BaseCommand {
    constructor(shoppingCartService, Logger) {
        super(CommandEnumType_1.Commands.SHOPPINGCART_GET);
    ...
    execute(data) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.shoppingCartService.findOne(data.params[0]);
        });
    }
    usage() {
...
], ShoppingCartGetCommand.prototype, "execute", null);
ShoppingCartGetCommand = tslib_1.__decorate([
...
], ShoppingCartGetCommand);
exports.ShoppingCartGetCommand = ShoppingCartGetCommand;
//# sourceMappingURL=ShoppingCartGetCommand.js.map