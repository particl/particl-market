...
export class BidActionService {
    ...
    public async generateBidDatasForMPA_BID(
        ...
        if (!listingItem.PaymentInformation.ItemPrice || !(typeof listingItem.PaymentInformation.ItemPrice.basePrice === 'number' && listingItem.PaymentInformation.ItemPrice.basePrice >= 0)) {
