...
export class MarketRepository {
    ...
    public async findOneByProfileIdAndReceiveAddressAndName(profileId: number, receiveAddress: string, name: string, withRelated: boolean = true):
        Promise<Market> {
        return await this.MarketModel.fetchByProfileIdAndReceiveAddressAndName(profileId, receiveAddress, name, withRelated);
    }
