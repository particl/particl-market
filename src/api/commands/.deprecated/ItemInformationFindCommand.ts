...
export class ItemInformationFindCommand implements RpcCommand<ItemInformation> {
    ...
    constructor(
        ...
        this.name = 'iteminformation.find';
    }
    ...
    public help(): string {
        return 'ItemInformationFindCommand: TODO: Fill in help string.';
    }
}
