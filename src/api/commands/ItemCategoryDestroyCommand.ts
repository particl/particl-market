...
export class ItemCategoryDestroyCommand implements RpcCommand<void> {
    ...
    constructor(
        ...
        this.name = 'itemcategory.destroy';
    }
    ...
    public help(): string {
        return 'ItemCategoryDestroyCommand: TODO: Fill in help string.';
    }
