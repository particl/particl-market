...
let BidActionService = class BidActionService {
    constructor(listingItemService, marketService, actionMessageService, profileService, smsgService, bidService, bidDataService, orderService, coreRpcService, bidFactory, orderFactory, eventEmitter, Logger) {
     ...
     */
    send(listingItem, bidderProfile, shippingAddress, additionalParams) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            // generate bidDatas
            const bidDatas = yield this.generateBidDatasForMPA_BID(listingItem, shippingAddress, additionalParams);
     ...
     * @returns {Promise<any[]>}
     */
    generateBidDatasForMPA_BID(listingItem, shippingAddress, additionalParams) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const unspent = yield this.coreRpcService.listUnspent(1, 99999999, [], false);
            if (!unspent || unspent.length === 0) {
                this.log.warn('No unspent outputs');
                throw new MessageException_1.MessageException('No unspent outputs');
            }
            ...
            if (basePrice) {
                ...
                if (sum < basePrice) {
                    ...
                    throw new MessageException_1.MessageException('You are too broke...');
                }
            }
            else {
            ...
            const addr = yield this.coreRpcService.getNewAddress(['_escrow_pub_' + listingItem.hash], false);
            ...
            const changeAddr = yield this.coreRpcService.getNewAddress(['_escrow_change'], false);
            ...
            // 0.16.0.3
            const validateAddress = yield this.coreRpcService.validateAddress(addr);
            ...
            if (!pubkey) {
                throw new MessageException_1.MessageException('Could not get public key for address!');
            }
    ...
    accept(listingItem, bid) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (bid.action === BidMessageType_1.BidMessageType.MPA_BID) {
                ...
                yield this.bidDataService.create({
     ...
     * @returns {Promise<any[]>}
     */
    generateBidDatasForMPA_ACCEPT(listingItem, bid, testRun = false) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (!buyerPubkey) {
                throw new MessageException_1.MessageException('Buyer public key was null!');
            }
            this.log.debug('addr: ', addr);
            this.log.debug('changeAddr: ', changeAddr);
            ...
            const escrow = yield this.coreRpcService.addMultiSigAddress(2, [pubkey, buyerPubkey].sort(), '_escrow_' + listingItem.hash);
            ...
            //
            const rawtx = yield this.coreRpcService.createRawTransaction(outputs.concat(buyerOutputs), txout);
            ...
            const releaseAddr = yield this.coreRpcService.getNewAddress(['_escrow_release'], false);
    ...
    cancel(listingItem, bid) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (bid.action === BidMessageType_1.BidMessageType.MPA_BID) {
                ...
                const retBid = yield this.bidService.update(bid.id, bidUpdateRequest);
                const marketPlaceMessage = {
                    version: process.env.MARKETPLACE_VERSION,
                    mpaction: bidMessage
                };
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (bidMessage) {
                ...
                if (existingBid) {
                    ...
                    throw new MessageException_1.MessageException('There is no existing Bid to accept.');
                }
            }
            else {
                throw new MessageException_1.MessageException('Missing BidMessage.');
    ...
    processCancelBidReceivedEvent(event) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const retBid = yield this.bidService.update(oldBid.id, bidUpdateRequest);
    ...
    processRejectBidReceivedEvent(event) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const listingItemModel = yield this.listingItemService.findOneByHash(bidMessage.item);
            const listingItem = listingItemModel.toJSON();
            // first save it
            const actionMessageModel = yield this.actionMessageService.createFromMarketplaceEvent(event, listingItem);
            const actionMessage = actionMessageModel.toJSON();
    ...
    createBid(bidMessage, listingItem, bidder) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (!_.isEmpty(listingItem.ListingItemTemplate)) {
                ...
                bidCreateRequest.address.type = AddressType_1.AddressType.SHIPPING_OWN;
...
BidActionService = tslib_1.__decorate([
    ...
    tslib_1.__param(9, inversify_1.inject(constants_1.Types.Factory)), tslib_1.__param(9, inversify_1.named(constants_1.Targets.Factory.BidFactory)),
    tslib_1.__param(10, inversify_1.inject(constants_1.Types.Factory)), tslib_1.__param(10, inversify_1.named(constants_1.Targets.Factory.OrderFactory)),
