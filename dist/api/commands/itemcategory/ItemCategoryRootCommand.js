...
let ItemCategoryRootCommand = class ItemCategoryRootCommand extends BaseCommand_1.BaseCommand {
    constructor(Logger) {
        super(CommandEnumType_1.Commands.CATEGORY_ROOT);
        this.Logger = Logger;
...
], ItemCategoryRootCommand.prototype, "execute", null);
ItemCategoryRootCommand = tslib_1.__decorate([
    tslib_1.__param(0, inversify_1.inject(constants_1.Types.Core)), tslib_1.__param(0, inversify_1.named(constants_1.Core.Logger)),
    tslib_1.__metadata("design:paramtypes", [Object])
], ItemCategoryRootCommand);
exports.ItemCategoryRootCommand = ItemCategoryRootCommand;
//# sourceMappingURL=ItemCategoryRootCommand.js.map