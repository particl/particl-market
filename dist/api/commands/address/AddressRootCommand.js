...
let AddressRootCommand = class AddressRootCommand extends BaseCommand_1.BaseCommand {
    constructor(Logger) {
        super(CommandEnumType_1.Commands.ADDRESS_ROOT);
        this.Logger = Logger;
...
], AddressRootCommand.prototype, "execute", null);
AddressRootCommand = tslib_1.__decorate([
    tslib_1.__param(0, inversify_1.inject(constants_1.Types.Core)), tslib_1.__param(0, inversify_1.named(constants_1.Core.Logger)),
    tslib_1.__metadata("design:paramtypes", [Object])
], AddressRootCommand);
exports.AddressRootCommand = AddressRootCommand;
//# sourceMappingURL=AddressRootCommand.js.map