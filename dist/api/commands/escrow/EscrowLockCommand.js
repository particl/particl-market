    ...
    execute(data) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return this.escrowActionService.lock({
                ...
                nonce: data.params[1],
                memo: data.params[2],
                action: EscrowMessageType_1.EscrowMessageType.MPA_LOCK
            });
        });
    }
    usage() {
