...
let FavoriteRemoveCommand = class FavoriteRemoveCommand extends BaseCommand_1.BaseCommand {
    ...
    execute(data) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const favoriteItem = yield this.favoriteItemService.search({ profileId: favoriteParams[0], itemId: favoriteParams[1] });
            if (favoriteItem === null) {
                this.log.warn(`FavoriteItem with the item id=${favoriteParams[1]} was not found!`);
                throw new NotFoundException_1.NotFoundException(favoriteParams[1]);
            }
